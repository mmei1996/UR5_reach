...
def ppo(env,
  ...
  (v): MLPCritic(
    ...
    def compute_loss_pi(data):
        ...
        #获取新logp!!!!!!!!!!!!!!!!!!!!!!!
        pi, logp = ac.pi(obs, act) #获取正态分布pi以及三个动作的对数概率和logp
    ...
    for epoch in range(epochs):
        for t in range(local_steps_per_epoch):
            #输出是动作，critic网络估计的这个state的价值以及动作的指数概率
            ...
            timeout = ep_len == max_ep_len #True or Falsch
...
if __name__ == '__main__':
    ...
    ppo(env,
        actor_critic=core.MLPActorCritic,
        ac_kwargs=dict(hidden_sizes=[args.hid] * args.l),#每个隐藏层有[args.hid]个神经元，有[args.l]层
        seed=args.seed,
